...
def get_metrics(
    ...
    gold_answer = gold_bags[0]
    predicted_answer = predicted_bags[0][0]
...
def compute_drop(output_dir, ground_truth_dir):
    return evaluate_prediction_file(prediction_path=output_dir, gold_path=ground_truth_dir)